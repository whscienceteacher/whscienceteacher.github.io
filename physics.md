...
[Ball on Ramp](/ballramp/) - **Lab/Phenomenon** - A simple ball on a ramp. Drag to change the height and width of the ramp. I use this one to practice planning and carrying out investigations. Also available as a sliding [block with friction](/blockramp/) with fixed μ. There is some randomness in the values so students can practice using the analyzing and interpreting data practice. **UPDATE FOR BUG FIX:** 2020-08-29 - The previous version of this app had a bug where the ball would continue into the floor. The bug has now been fixed. I'm very sorry! That's what I get for hard coding values. 

[Cannon](/cannon/) - **Lab/Phenomenon** - Cannon that fires a ball. You can change the power of the cannon and the angle of fire. Students use a ruler to measure the range of the cannon and a stopwatch to measure air time. There is a fair amount of randomness so students can practice more of the skills in analyzing and interpreting data. This version allows angles 10° to 40°. **Update: 2020-09-17** Now loads the right app. Also available with [high angles only (50° to 80°)](/cannon/full/) and the [full range of angles(10° to 80°)](/cannon/full/)
...
[Collisions](/collisions/) - **Lab/Phenomenon** - Change masses and initial velocities and measure final velocities.
