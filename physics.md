...
[Cannon](/cannon/) - **Physics** - Cannon that fires a ball. You can change the power of the cannon and the angle of fire. Students use a ruler to measure the range of the cannon and a stop watch to measure air time. There is a fair amount of randomness so students can practice more of the skills in analyzing and interpreting data. 
...
[Elastic Energy](/elastic/) - **Physics** - Drag to stretch a rubber band. Shows the distance, force requried, and elastic energy. I use this for practice describing patterns as linear and non-linear. 
...
[Storms](/storms/) - **Physics** - Students change the temperature of the atmosphere and see the effect on clouds and wind. A very simlified version of a weather simulation. I used this as a summative assessment where students practiced finding patterns and then constructing explanations of why climate change causes mroe violent storms using ideas about kinetic and potential energy. 
...
[Wave Measurement Practice](/wavemprac/) - **Physics** - The app generatates a graph of a wave on a grid. Students practice measuring wavelenght, amplitude, and number of waves. The app checks if they are right and keeps track of how many they have in a row.  
